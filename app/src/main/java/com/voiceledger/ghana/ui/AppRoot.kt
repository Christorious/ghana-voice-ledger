...
/**
 * Hosts the two tabs — Today (sales) and Credit (debts) — behind a shared bottom bar.
 * Each screen keeps its own scaffold and simply renders the same bottom bar, so switching
 * tabs is seamless without pulling in a navigation library.
 */
@Composable
fun AppRoot(
